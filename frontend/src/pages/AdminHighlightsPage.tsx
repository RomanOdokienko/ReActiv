...
const TENANT_GROWTH_ORDER: ImportTenantId[] = [
  "gpb",
  "reso",
  "alpha",
  "sovcombank",
...
const WEEKLY_HIGHLIGHTS: WeeklyHighlightItem[] = [
  ...
  {
    period: "22-29 марта 2026",
    title: "Спринт 5. Контентный контур и внешняя упаковка платформы",
    points: [
      "Собрана и запущена страница «О платформе» с понятным описанием продукта, логики работы и ценности для клиентов.",
      "Запущена отдельная страница «Партнерам» с позиционированием для лизингодателей и структурированным сценарием подключения.",
      "Развернут блоговый контур платформы: добавлены страницы блога и статей, подготовлена база для регулярного контент-маркетинга.",
      "Выполнен базовый SEO-блок: проработаны мета-данные, заголовочная структура, индексационные настройки и улучшена семантика ключевых страниц.",
    ],
  },
  {
    period: "30 марта - 5 апреля 2026",
    title: "Спринт 6. Безопасность, стабильность и оптимизация производительности",
    points: [
      "Проведен объемный цикл работ по безопасности: усилен контроль доступов по ролям, закрыты чувствительные контуры и выровнены правила доступа.",
      "Укреплена устойчивость админского и аналитического блока: добавлены защитные сценарии при частичных сбоях источников данных.",
      "Выполнен пакет оптимизаций производительности страниц: ускорены рендер и навигация, снижена нагрузка на клиент при работе с каталогом и контентом.",
      "Проведена техническая оптимизация фронтенд-слоя и ассетов: улучшена отзывчивость интерфейса и качество пользовательского опыта на ключевых страницах.",
    ],
  },
];
